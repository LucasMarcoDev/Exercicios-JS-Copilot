...
const crusoEspecial =document.getElementById("c1")
...
const query_crusoEspecial =document.querySelectorAll("#c1")[0]

console.log(query_crusoEspecial)
console.log(query_cursosC2)

// console.log(cursosTodos)
// console.log(cursosC1)
// console.log(cursosC2)
// console.log(crusoEspecial)
